  ...
  const renderCollapsibleSection = (id: string, title: string, content: React.ReactNode) => (
    <div className="control-group">
      <div className="section-header" onClick={() => toggleSection(id)}>
        <label>{title}</label>
        <span className="section-toggle">{collapsedSections.has(id) ? '▼' : '▲'}</span>
      </div>
      {!collapsedSections.has(id) && content}
    </div>
  )
    ...
    <div className="particle-controls">
      ...
      {!isCollapsed && (
        <div className="panel-content">
          {renderCollapsibleSection('emitter', 'Emitter Properties', (
          ...
          {renderCollapsibleSection('position', 'Emitter Position', (
            <div className="position-controls">
              <div className="axis-control">
                <label>X:</label>
                <input
          ...
          {renderCollapsibleSection('properties', 'Particle Properties', (
            <div className="position-controls">
              <div className="axis-control">
          ...
          {renderCollapsibleSection('colors', 'Colors', (
          ...
          {renderCollapsibleSection('physics', 'Physics', (
            <div className="position-controls">
              <div className="axis-control">
                <label>Gravity:</label>
                <input
          ...
          {renderCollapsibleSection('wind', 'Wind', (
            <div className="position-controls">
              <div className="axis-control">
                <label>X:</label>
                <input
          ...
          {renderCollapsibleSection('behavior', 'Behavior', (
            <div className="position-controls">
              <div className="axis-control">
                <label>Fade In:</label>
                <input
